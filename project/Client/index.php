...
<html lang="en" data-bs-theme="auto">
  ...
  <head>
    ...
    <link rel="stylesheet" href="frontend/assets/css/calendar.css">
    <link href="frontend/assets/css/header.css" rel="stylesheet">
    <link href="frontend/assets/css/footer.css" rel="stylesheet">
    <link href="frontend/assets/css/global.css" rel="stylesheet">
    <link href="frontend/assets/css/hotel.css" rel="stylesheet">
    <link href="frontend/assets/css/patterns.css" rel="stylesheet">
    <link href="frontend/assets/css/colors.css" rel="stylesheet">
    <link href="frontend/assets/css/carousel.css" rel="stylesheet">
    <link href="frontend/assets/css/hotels.css" rel="stylesheet">
    <link href="frontend/assets/css/auth.css" rel="stylesheet">
    <link href="frontend/assets/css/rooms.css" rel="stylesheet">
    <link href="frontend/assets/css/nunito.css" rel="stylesheet">
    <link href="frontend/assets/css/book.css" rel="stylesheet">
    <link rel="icon" type="image/png" href="../frontend/assets/images/icon.png" sizes="16x16">
...
<body class="<?php echo ((isset($_GET['page']) && $_GET['page'] !== 'hotel' && $_GET['page'] !== 'auth') && (!isset($_GET['method']) || $_GET['method'] !== 'bookings')) ? 'pattern-mono' : 'pattern-color'; ?>">
    ...
    <?php
require_once 'frontend/src/autoloaderFrontend.php';
...
if (isset($_GET['selectedHotel'])) {
    ...
    foreach ($hotels as $hotel) {
        if ($hotel->getName() === $selectedHotel) {
            ...
            header("Location: index.php?page=room&hotelId=" . $hotel->getId());
...
?>
    ...
    <header class="navbar navbar-expand-lg bg-light sticky-top bg-light border border-bottom-1 ">
      <div class="container-fluid">
        <img src="../frontend/assets/images/logo.png" class="logo-header" alt="Logo">
    ...
    <li class="nav-item">
        <a id="nav-profilo" class="nav-link fs-5 <?= ($page === 'auth') ? 'active' : '' ?>" aria-current="page" href="index.php?page=auth&authState=login">Profilo</a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a id="nav-prenotazioni" class="nav-link fs-5 <?= ($page === 'book' && $method != 'prebook') ? 'active' : '' ?>" href="index.php?page=book&method=bookings">Prenotazioni</a>
    </li>
    <li class="nav-item">
...
<footer id="footer" class="d-flex flex-wrap d-none  justify-content-between align-items-center py-3 my-4 border-top mb-0 p-2 bg-light border border-top-1 ">
  ...
  <a href="#" class="col-md-4 d-flex align-items-center justify-content-center  mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
    <img src="../frontend/assets/images/logo.png" class="logo-footer" alt="Logo">

  </a>

  <ul  id="nav-tabs"class="nav col-md-4 justify-content-end">
  <li class="nav-item">
        <a id="footer-profilo" href="index.php?page=auth&authState=login" class="nav-link px-2 text-body-secondary fs-5 <?= ($page === 'auth') ? 'fw-bold' : '' ?>">Profilo</a>
    </li>
    <li class="nav-item">
...
<script src="frontend/assets/dist/js/jquery.min.js"></script>
...
<script src='https://npmcdn.com/react-dom@15.3.0/dist/react-dom.min.js'></script>
<script src='https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.14.1/moment-with-locales.min.js'></script>
<script src="frontend/assets/js/objects.js"></script>
<script src="frontend/assets/js/ajax.js"></script>
<script src="frontend/assets/js/index.js"></script>
<script  src="frontend/assets/js/calendar.js"></script>
<script  src="frontend/assets/js/hotel.js"></script>
<script src="frontend/assets/js/hotel.js"></script>
<script src="frontend/assets/js/auth.js"></script>
<script src="frontend/assets/js/home.js"></script>
<script src="frontend/assets/js/room.js"></script>
<script src="frontend/assets/js/book.js"></script>
