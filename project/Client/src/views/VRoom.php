<?php
    ...
    */
                ...
                <hr class="featurette-divider">
                    ...
                    <div class="col-12 col-lg-6 <?php echo (($i + 1) % 2 !== 0 ? ' order-lg-1' : ''); ?>">
                        <div id="container-img-stanza-<?php echo $i;?>">
                            ...
                            <div id="input-placeholder-img-<?php echo $i;?>"><svg class="mx-auto w-100 h-100 border border-1 rounded shadow bd-placeholder-img  rounded-top-0" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img"  preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#55595c"></rect></svg>                                 
                            </div>
            ...
            <div class="container marketing mb-5 mt-5">
                ...
                <div class="row featurette">
                    <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto w-100 h-100 border border-1 rounded shadow" width="500" height="500" src="<?php echo $hotel->getImage(); ?>">  
                        </div>
    ...
    if(!isset($_SESSION['email']) || empty($_SESSION['email'])) {
        echo '<a href="../../index.php?page=auth&authState=login" class="btn btn-lg btn-primary mt-4 mb-5" type="submit">Autenticati</a>';
    }
?>
                 </div>
                                ...
                                <div class="col">
                                    <div class="card mb-4 rounded-3 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a type="button" href="#stanza-<?php echo ($i);?>" class="w-100 btn btn-lg btn-outline-primary">Dettagli</a>
                                        </div>
                                    </div>
                                </div>
                                <?php endforeach; ?>
                        ...
                        <div class="row featurette" id="stanza-<?php echo ($i);?>">
                            ...
                            <div class="col-12 col-lg-6 <?php echo ($i % 2 !== 0 ? ' order-lg-1' : ''); ?>">
                                <img  class="mx-auto w-100 h-100 border border-1 rounded shadow"  width="500" height="500" src="<?php echo $room->getImage(); ?>">  
                            </div>
                        </div>
                        <ul class="list-group list-group-flush mt-2">
                            <li class="list-group-item d-flex justify-content-between align-items-center" style="background-color: transparent;">
                                Totale di <?php echo $room->getName(); ?>
                                <span class="badge bg-primary text-light"><?php echo $room->getTotalRooms(); ?></span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center" style="background-color: transparent;">
                                Prenotabili oggi di <?php echo $room->getName(); ?>
                                <span class="badge bg-primary text-light"><?php echo $room->getAvailability(); ?></span>
                            </li>
                        </ul>
                    <?php endforeach; ?>
