                ...
                <div class="container">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3" id="hotels-list">
                        <?php foreach ($hotels as $hotel): ?>
                            <a href="../../index.php?page=room&hotelId=<?php echo $hotel->getId();?>" class="col text-decoration-none hotel-card hotel-card-able" id="hotel-card-<?php echo $hotel->getId(); ?>">
                        ...
                        <a href="../../index.php?page=room&hotelId=newHotel" class="col text-decoration-none hotel-card hotel-card-able">
