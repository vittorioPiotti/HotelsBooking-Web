...
$(function() {
                    ...
                    <div class="row featurette on-appear" id="inner-container-input-stanza-${roomId}">
                        <div class="col-12 col-lg-6">
                            <div id="container-input-stanza-${roomId}">
                                ...
                                <div class="input-group mb-3" style="max-width:170px;">
                                    ...
                                    <span class="mb-0 input-group-text">Costo<small class="text-body-secondary fw-light ms-2">â‚¬/gg</small></span>
                                </div>
                                <div class="input-group mb-3" style="max-width:200px;">
                                    <span class="input-group-text">QuantitÃ  Stanze</span>
                        ...
                        <div class="col-12 col-lg-6">
                            <div id="container-img-stanza-${roomId}" value="">
                                ...
                                <img id="content-img-stanza-${roomId}" class="bd-placeholder-img bd-placeholder-img-lg rounded-top-0 featurette-image img-fluid mx-auto w-100 h-100 border border-1 rounded " width="500" height="500" src="<?php echo $room->getImage(); ?>">
                            </div>
                        </div>
                    </div>
                </div> 
                ...
                function addOnChangeBtnViewInputStanza(index,btnView,containerInput,containerImg,inputDesc,inputNome,contentImg,inputCost,inputLock,indexRoom,inputQuant,inputImg){
                    ...
                    $(`#${btnView}`).on('click', async function() {
                        ...
                        if(state){
                            ...
                            var imgInner = `<img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto w-100 h-100 border border-1 rounded " width="500" height="500" src="${_img[index] }">`
                            var imgPlace = ` <div class=" placeholder-glow"><svg class="mx-auto w-100 h-100 border border-1 rounded  bd-placeholder-img placeholder " width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img"  preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#55595c"></rect></svg>         </div>                             `
                            ...
                            $(`#${containerInput}`).html(`
                             ...
                             ${
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center" style=" background-color: transparent;">
                                    ...
                                    <span class="fs-2 mb-0"><span id="${inputCost}" value="${_cost[index]}">${_cost[index]}</span><small class="text-body-secondary fw-light ms-2">â‚¬/gg</small></span>
                                    </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center" style=" background-color: transparent;">
                ...
                $('#update-btn-hotel').on('click', async function() {
                    ...
                    if (await checkItems(`#container-input-hotel`,`#container-img-hotel`,`#input-nome-hotel`,`#input-desc-hotel`,``,`#content-img-hotel`, 0,``)) {
                        ...
                        for (let i = 0; i < app.length; i++) {
                            if (seen[app[i]]) {
                                // Se il valore Ã¨ giÃ  stato visto, non Ã¨ unico
                                isUnique = false;
                                break;
                            } else {
    ...
    // Se l'attributo Ã¨ presente, inverti il suo stato
